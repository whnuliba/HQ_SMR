...
{
    [PublicAPI]
    public class CwAutofacJobFactory :IJobFactory, IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="CwAutofacJobFactory" /> class.
        /// </summary>
        ...
        ///     <see langword="null" />.
        /// </exception>
        public CwAutofacJobFactory(ILifetimeScope lifetimeScope, object scopeTag,
