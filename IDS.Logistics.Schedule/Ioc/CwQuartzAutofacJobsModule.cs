...
namespace IDS.Logistics.Schedule.Ioc
{
    ...
    /// </summary>
    [PublicAPI]
    public class CwQuartzAutofacJobsModule : Module
    {
        [NotNull] readonly Assembly[] _assembliesToScan;


        /// <summary>
        ///     Initializes a new instance of the <see cref="CwQuartzAutofacJobsModule" /> class.
        /// </summary>
        ...
        public CwQuartzAutofacJobsModule([NotNull] params Assembly[] assembliesToScan)
        {
